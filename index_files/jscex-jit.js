(function () {
            ...
            _visitors: {
                ...
                switch: function (ast) {
                    ...
                    for (var i = 0; i < cases.length; i++) {
                        ...
                        noBinding =
                            noBinding && this._noBinding(caseStmt.stmts);
                    }
                ...
                if: function (ast) {
                    ...
                    while (true) {
                        ...
                        noBinding =
                            noBinding && this._noBinding(condStmt.stmts);
                    ...
                    if (elsePart) {
                        ...
                        noBinding =
                            noBinding && this._noBinding(ifStmt.elseStmts);
                    }
                ...
                try: function (ast, stmts) {
                    ...
                    if (catchClause) {
                        ...
                        noBinding =
                            noBinding && this._noBinding(tryStmt.catchStmts);
                    }
                    ...
                    if (finallyStatements) {
                        ...
                        this._visitStatements(
                            finallyStatements,
                            tryStmt.finallyStmt.stmts
                        );

                        noBinding =
                            noBinding &&
                            this._noBinding(tryStmt.finallyStmt.stmts);
                    }
            ...
            _rawVisitors: {
                ...
                call: function (ast) {
                    if (_isJscexPattern(ast)) {
                        ...
                        var invalidBind =
                            ast[1][0] == "name" && ast[1][1] == this._binder;
                        if (invalidBind) {
                            this._pos = { inFunction: true };
                            this._buffer = [];
                        }
    ...
    if (isCommonJS) {
        ...
        if (typeof Jscex === "undefined") {
            throw new Error(
                'Missing root object, please load "jscex" module first.'
            );
        }
