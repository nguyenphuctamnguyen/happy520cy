(function () {
    ...
    typeof __jscex__async__taskIdSeed === "undefined" &&
        (__jscex__async__taskIdSeed = 0);
    var l = function (b) {
            return (
                typeof b.start === "function" &&
                        ...
                        if (!this.isCancellationRequested) {
                            ...
                            for (var f = 0; f < a.length; f++)
                                try {
                                    ...
                                    b.logger.warn(
                                        "[WARNING] Cancellation handler threw an error: " +
                                            c
                                    );
                                }
                        }
                ...
                e.prototype = {
                    ...
                    complete: function (a, f) {
                        ...
                        this.error &&
                            ...
                            !c.complete &&
                            b.logger.warn(
                                "[WARNING] An unhandled error occurred: " +
                                    this.error
                            );
                    },
    ...
    if (
        ...
        if (typeof Jscex === "undefined")
            throw Error(
                'Missing the root object, please load "jscex" module first.'
            );
